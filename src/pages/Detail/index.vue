          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd v-for="spuSaleAttrValue in spuSaleAttr.spuSaleAttrValueList"
                  @click='changeActive(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList)' :key="spuSaleAttrValue.id"
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="minsNum">-</a>
              </div>
...
export default {
  ...
  methods: {
    // 切换sku信息
    changeActive(spuSaleAttrValue, saleAttrList) {
      saleAttrList.forEach(element => {
        element.isChecked = '0'
      });
