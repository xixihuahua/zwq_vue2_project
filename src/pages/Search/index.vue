                ...
                <div class="list-wrap">
                  <div class="p-img">
                    <a href="item.html" target="_blank">
                      <img v-if="good.defaultImg" :src="good.defaultImg"/>
                      <img v-else src="./images/mobile03.png"/>
                    </a>
                  </div>
                  <div class="price">
                    <strong>
...
export default {
  ...
  beforeMount() {
    ...
    Object.assign(this.queryParams, query, params)
  },
  mounted() {
    this.getSearchList()
  },
  ...
  methods: {
    // 查询数据
    getSearchList() {
      this.$store.dispatch('getSearchList', this.queryParams)
    },
    // 删除分类
    removeCategoryName() {
      this.queryParams.category1Id = undefined;
      this.queryParams.category2Id = undefined;
      this.queryParams.category3Id = undefined;
